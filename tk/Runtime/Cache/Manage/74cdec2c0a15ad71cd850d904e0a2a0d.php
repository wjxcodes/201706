...
<div id="main" class="main" >
    <!-- 主体内容  -->
    <div class="content" >
        <div class="title"><?php echo ($pageName); ?> [<a href="<?php echo U('PowerUser/updateCache');?>">更新缓存</a>]</div>
        <!--  功能操作区域  -->
        <div class="operate">
        ...
        <div class="list" >
            ...
            <table id="checkList" class="list" cellpadding="5" cellspacing="0" border="1">
                ...
                <?php if(is_array($userGroupArray)): $i = 0; $__LIST__ = $userGroupArray;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$node): $mod = ($i % 2 );++$i;?><tr class="row lists" jl=''>
                    <td><input type="checkbox" class="key" value="<?php echo ($node["PUID"]); ?>"></td>
                    <td><?php echo ($node["PUID"]); ?></td>
                    <td><a href="#" class="btedit" thisid="<?php echo ($node["PUID"]); ?>"><?php echo ($node["UserGroup"]); ?></a></td>
                    <td><?php echo ($node["groupList"]); ?></td>
                    <td><?php echo ($node["UserGroupName"]); ?></td>
                    <td><?php if(($node["IfDefault"]) == "1"): ?><font color="red">是</font><?php else: ?>否<?php endif; ?></td>
                    <td><?php echo ($node["OrderID"]); ?></td>
                    <td><a href="#" class="btedit" thisid="<?php echo ($node["PUID"]); ?>">编辑</a>&nbsp;</td>
