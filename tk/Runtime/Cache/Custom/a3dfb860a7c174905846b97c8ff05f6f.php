...
//指定当前组模块URL地址 
var URL = '/Custom/CustomTestTaskList';
var APP     =     '';
var PUBLIC = '/Public';
var softdog=0;
...
<!-- 主体内容  -->
<div class="content" >
<div class="title"><?php echo ($pageName); ?> [<a href="<?php echo U('Custom/CustomTestTaskList/overGroup');?>">超时统计</a>]</div>
<!--  功能操作区域  -->
<div class="operate">
    ...
    <!-- 查询区域 -->
    <FORM id="form1" METHOD="POST" ACTION="/Custom/CustomTestTaskList">
    <div class="fRig">
    ...
    <div id="searchM" class=" none search cBoth">
        ...
        <TR>
            ...
            <TD class="tRight" width="80">所属状态：</TD>
...
<table id="checkList" class="list" cellpadding="5" cellspacing="0" border="1">
    ...
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$node): $mod = ($i % 2 );++$i;?><tr class="row lists" jl='' >
        <td style="text-align:center"><input type="checkbox" class="key" value="<?php echo ($node["ListID"]); ?>"></td>
        <td style="text-align:center"><?php echo ($node["ListID"]); ?></td>
        <td style="text-align:center"><?php echo ($node["CheckUser"]); ?></td>
        ...
        <td style="text-align:center"><?php echo (date("Y-m-d H:i:s",$node["TaskTime"])); ?></td>
