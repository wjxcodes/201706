...
$.fn.tree = function(settings){
	...
	return $(this).each(function(){
		...
		tree.find('li:has(ul)').find('>span').addClass('tree-parentspan tree-parent-collapsedspan');
		...
		tree
			...
			.attr('aria-expanded', 'true')
				.find('>span')
				.removeClass('tree-parent-collapsedspan')
				.next()
		...
		tree
			...
			.bind('expand',function(event){
				...
				target.prev().removeClass('tree-parent-collapsedspan');
			...
			.bind('collapse',function(event){
				...
				target.prev().addClass('tree-parent-collapsedspan');
		...
		tree.find('span')
			.click(function(event){
				...
				var target = $(event.target).next().dblclick();
			});
		tree.find('a')
