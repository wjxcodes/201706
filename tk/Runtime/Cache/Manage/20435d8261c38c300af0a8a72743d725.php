...
<div class="operate">
    ...
    <!-- 查询区域 -->
    <FORM METHOD="POST" ACTION="/Manage/Word">
    <div class="fRig">
        <div class="fLeft"><span id="key"><INPUT id="name" TYPE="text" NAME="name" value="<?php echo ($_REQUEST['name']); ?>" title="分词查询" class="medium" ></span></div>
    ...
    <div id="searchM" class=" none search cBoth">
        ...
        <TR>
            ...
            <TD><INPUT TYPE="text" NAME="Word" class="small" value="<?php echo ($_REQUEST['Word']); ?>" ></TD>
...
<table id="checkList" class="list" cellpadding="5" cellspacing="0" border="1">
    ...
    <?php if(is_array($word_array)): $i = 0; $__LIST__ = $word_array;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$node): $mod = ($i % 2 );++$i;?><tr class="row lists" jl=''>
        <td><input type="checkbox" class="key" value="<?php echo ($node["WordID"]); ?>"></td>
        <td><?php echo ($node["WordID"]); ?></td>
        <td><a href="#" class="btedit" thisid="<?php echo ($node["WordID"]); ?>"><?php echo ($node["Word"]); ?></a></td>
        <td><?php echo ($node["SubjectName"]); ?></td>
        <td><?php echo ($node["KlName"]); ?></td>
        <td><?php echo ($node["Weight"]); ?></td>
        <td><a href="#" class="btedit" thisid="<?php echo ($node["WordID"]); ?>">编辑</a>&nbsp;</td>
