...
(function () {
    ...
    scrawl.prototype = {
        ...
        _addBoardListener:function (saveNum) {
            ...
            drawStepIndex += 1;
            //20141112 修改 增加touchstart和touchmove方法
            domUtils.on(canvas, ["touchstart", "touchmove","touchend", "mousedown", "mousemove", "mouseup", "mouseout"], function (e) {
                ...
                switch (e.type) {
                    case 'touchstart':
                        ...
                        me.isScrawl = true;
                        context.beginPath();
                        startX = e.changedTouches[0].pageX-margin;
                        startY = e.changedTouches[0].pageY-margin;
                        context.moveTo(startX,startY);
                        break;
                    case 'touchmove':
                        e.preventDefault();
                        if (isTouchEnd || !isTouchStart) {
                            return;
                        }
                        endX = e.changedTouches[0].pageX-margin;
                        endY = e.changedTouches[0].pageY-margin;
