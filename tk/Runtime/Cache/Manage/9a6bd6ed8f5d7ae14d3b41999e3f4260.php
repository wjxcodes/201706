...
<TR>
    ...
    <TD class="tLeft" ><INPUT TYPE="password" class="bLeft" NAME="Password" value="" /><?php if(isset($edit["AdminID"])): ?>* 如果不修改请留空<?php endif; ?>  密码必须为8位以上数字，字母组合</TD>
</TR>
<TR>
...
<TR>
    ...
    <div class="impBtn fLeft"><INPUT tag='form1' u="<?php echo U('Public/password');?>" TYPE="button" value="保存" class="save imgButton mysubmit"></div>
