...
<!-- 主体内容  -->
<div class="content" >
<div class="title"><?php echo ($pageName); ?> <a href="<?php echo U('Ability/updateCache');?>">更新缓存</a></div>
<!--  功能操作区域  -->
<div class="operate">
...
<table id="checkList" class="list" cellpadding="5" cellspacing="0" border="1">
    ...
    <?php if(is_array($abilityArray)): $i = 0; $__LIST__ = $abilityArray;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$node): $mod = ($i % 2 );++$i;?><tr class="row lists" jl=''>
        <td><input type="checkbox" class="key" value="<?php echo ($node["AbID"]); ?>"></td>
        <td><?php echo ($node["AbID"]); ?></td>
        <td><a href="#" class="btedit" thisid="<?php echo ($node["AbID"]); ?>"><?php echo ($node["AbilitName"]); ?></a></td>
        <td><?php echo ($node["SubjectName"]); ?></td>
        <td><?php echo ($node["OrderID"]); ?></td>
        <td><a href="#" class="btedit" thisid="<?php echo ($node["AbID"]); ?>">编辑</a>&nbsp;</td>
