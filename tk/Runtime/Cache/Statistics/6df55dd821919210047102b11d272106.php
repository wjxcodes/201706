...
<div id="main" class="main" >
    ...
    <div class="content" >
						...
						<!-- <tr> -->
							...
							<!-- <td class="tLeft" > -->
								<!-- <select name="DocGrade" class="DocGrade" id='grade'> -->
									<!-- <?php if($edit["SubjectID"] == ''): ?>-->
										<!-- <option value="">请先选择学科</option> -->
									<!-- <?php else: ?> -->
										<!-- <option value="">请选择年级</option> -->
										<!-- <?php if(is_array($grade)): $i = 0; $__LIST__ = $grade;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$gvo): $mod = ($i % 2 );++$i;?>-->
											<!-- <option value="<?php echo ($gvo["GradeID"]); ?>" <?php if(($gvo["GradeID"]) == $edit["GradeID"]): ?>selected="selected"<?php endif; ?>><?php echo ($gvo["GradeName"]); ?></option> -->
        ...
        <div class="list" >
			...
			<tr>
                <td>布置作业总次数:<?php echo ($count); ?>次</td>
                <td>学生作答人数:<?php echo ($counts); ?>人</td>
                <td>试题数量：<?php echo ($TestNum); ?>个</td>
                <td>知识点数量：<?php echo ($LoreNum); ?>个</>  
             </tr>
			</table>
			</div>
            <!-- Think 系统列表组件开始 -->
