...
class QrCode
{
    ...
    {   
        $this->setPath(APP_PATH.'../www/Public/plugin/qrCodeAssets/data');
        $this->setImagePath(APP_PATH.'../www/Public/plugin/qrCodeAssets/image');
        $this->setLabelFontPath(APP_PATH.'../www/Public/plugin/qrCodeAssets/font/opensans.ttf');
        $this->setText($text);
    }
