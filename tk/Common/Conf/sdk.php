...
//定义回调URL通用的URL
define('URL_CALLBACK', 'http://' . $_SERVER['SERVER_NAME'] . '/User/Index/[sdk]CallBack');
...
return array(
    ...
    //腾讯QQ登录配置
    'THINK_SDK_QQ' => array(
        'APP_KEY' => '101264765', //应用注册成功后分配的 APP ID
        'APP_SECRET' => 'fe458b4c4d475ae4cca200265f04eaef', //应用注册成功后分配的KEY
        'CALLBACK' => str_replace('[sdk]','QQ',URL_CALLBACK) ,
    ),
    //腾讯微博配置
