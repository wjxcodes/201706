...
<!-- 主体内容  -->
<div class="content" >
<div class="title"><?php echo ($pageName); ?> <a href="<?php echo U('Skill/updateCache');?>">更新缓存</a></div>
<!--  功能操作区域  -->
<div class="operate">
    ...
    <!-- 查询区域 -->
    <FORM METHOD="POST" ACTION="/Manage/Skill">
    <div class="fRig">
    ...
    <div id="searchM" class=" none search cBoth">
        ...
        <TR>
            ...
            <TD><INPUT TYPE="text" NAME="SkillName" class="small" value='<?php echo ($_REQUEST['SkillName']); ?>' ></TD>
            ...
            <TD><SELECT id="skill" class="medium bLeft selectSkill" NAME="SkillID[]">
            <option value="">选择</option>
            </SELECT></TD>
        </TR>
        </TABLE>
...
<table id="checkList" class="list" cellpadding="5" cellspacing="0" border="1">
    ...
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$node): $mod = ($i % 2 );++$i;?><tr class="row lists" jl=''>
        <td><input type="checkbox" class="key" value="<?php echo ($node["SkillID"]); ?>"></td>
        <td><?php echo ($node["SkillID"]); ?></td>
        <td><?php echo ($node["SkillChild"]); ?> <a href="<?php echo U('Skill/index',array('SkillID'=>$node['SkillID']));?>"><?php echo ($node["SkillName"]); ?></a></td>
        <td><?php echo ($node["SubjectName"]); ?></td>
        <td><?php echo ($node["OrderID"]); ?></td>
        <td><a href="#" class="btedit" thisid="<?php echo ($node["SkillID"]); ?>">编辑</a>&nbsp;</td>
...
<script language="javascript">
    $('#subject').subjectSelectChange('/Manage/Skill',{'style':'getMoreData','list':'skill'});
    $('.selectSkill').skillSelectChange("/Manage/Skill");
</script>
<!-- 主页面结束 -->
