...
<!-- 主体内容  -->
<div class="content" >
<div class="title"><?php echo ($pageName); ?> <a href="<?php echo U('CaseLoreDocLabel/updateCache');?>">更新缓存</a></div>
<!--  功能操作区域  -->
<div class="operate">
...
<table id="checkList" class="list" cellpadding="5" cellspacing="0" border="1">
    ...
    <?php if(is_array($tagArray)): $i = 0; $__LIST__ = $tagArray;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$node): $mod = ($i % 2 );++$i;?><tr class="row lists" jl=''>
        <td><input type="checkbox" class="key" value="<?php echo ($node["LabelID"]); ?>"></td>
        <td><?php echo ($node["LabelID"]); ?></td>
        <td><a href="#" class="btedit" thisid="<?php echo ($node["LabelID"]); ?>"><?php echo ($node["LabelName"]); ?></a></td>
        <td><?php echo ($node["DefaultStart"]); ?></td>
        <td><?php echo ($node["LoreField"]); ?></td>
        <td><?php echo ($node["Description"]); ?></td>
        <td><?php echo ($node["OrderID"]); ?></td>
        <td><a href="#" class="btedit" thisid="<?php echo ($node["LabelID"]); ?>">编辑</a>&nbsp;</td><?php endforeach; endif; else: echo "" ;endif; ?>
