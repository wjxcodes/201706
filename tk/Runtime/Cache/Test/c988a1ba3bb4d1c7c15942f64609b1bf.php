...
<table id="checkList" class="list" cellpadding="5" cellspacing="0" border="1">
    ...
    <?php if(is_array($tagArray)): $i = 0; $__LIST__ = $tagArray;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$node): $mod = ($i % 2 );++$i;?><tr class="row lists" jl=''>
        <td><input type="checkbox" class="key" value="<?php echo ($node["TagID"]); ?>"></td>
        <td><?php echo ($node["TagID"]); ?></td>
        <td><a href="#" class="btedit" thisid="<?php echo ($node["TagID"]); ?>"><?php echo ($node["TagName"]); ?></a></td>
        <td><?php echo ($node["DefaultStart"]); ?></td>
        <td><?php echo ($node["TestField"]); ?></td>
        <td><?php echo ($node["Description"]); ?></td>
        <td><?php echo ($node["OrderID"]); ?></td>
        <td><a href="#" class="btedit" thisid="<?php echo ($node["TagID"]); ?>">编辑</a>&nbsp;</td><?php endforeach; endif; else: echo "" ;endif; ?>
