...
<!-- 主体内容  -->
<div class="content" >
<div class="title"><?php echo ($pageName); ?> <a href="<?php echo U('ClassGrade/updateCache');?>">更新缓存</a></div>
<!--  功能操作区域  -->
<div class="operate">
...
<table id="checkList" class="list" cellpadding="5" cellspacing="0" border="1">
    ...
    <?php if(is_array($gradeArray)): $i = 0; $__LIST__ = $gradeArray;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$node): $mod = ($i % 2 );++$i;?><tr class="row lists" jl=''>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td><a href="#" class="btedit" thisid="<?php echo ($node["GradeID"]); ?>"><?php echo ($node["GradeName"]); ?></a></td>
        ...
        <?php if(is_array($node['sub'])): $i = 0; $__LIST__ = $node['sub'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sub): $mod = ($i % 2 );++$i;?><tr class="row lists" jl=''>
            <td><input type="checkbox" class="key" value="<?php echo ($sub["GradeID"]); ?>"></td>
            <td>　　<?php echo ($sub["GradeID"]); ?></td>
            <td>　　<a href="#" class="btedit" thisid="<?php echo ($sub["GradeID"]); ?>"><?php echo ($sub["GradeName"]); ?></a></td>
            <td><?php echo ($sub["OrderID"]); ?></td>
            <td><a href="#" class="btedit" thisid="<?php echo ($sub["GradeID"]); ?>">编辑</a>&nbsp;</td>
