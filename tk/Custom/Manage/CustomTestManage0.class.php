...
class CustomTestManage extends BaseController  {
     ...
     */
     public function index(){
         ...
         $count=$customTest->customTestSelectCount($data); //按统计校本题库试题总数
         $this->pageList($count, $perPage, $map);
         $page=page($count,$_GET['p'],$perPage).','.$perPage;
         $list=$customTest->customTestSelectByPageList($data,$page, $doc); //按统计校本题库试题分页查看数据
