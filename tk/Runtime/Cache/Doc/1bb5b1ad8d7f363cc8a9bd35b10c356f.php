...
<div id="main" class="main" >
    ...
    <div class="content">
        <!--  功能操作区域  -->
        <div class="title"><?php echo ($pageName); ?> [ <a href="<?php echo U('Doc/WlnDoc/xlslist');?>">返回列表</a> ] [ <a href="javascript:history.go(-1);">返回上一页</a> ]</div>
        <!-- 功能操作区域结束 -->
                ...
                <tr>
                    ...
                    <td class="tLeft" >
                        <select name="DocYear">
                            ...
                            <?php $__FOR_START_7696__=$thisYear;$__FOR_END_7696__=1990;for($vo=$__FOR_START_7696__;$vo > $__FOR_END_7696__;$vo+=-1){ ?><option value="<?php echo ($vo); ?>" <?php if(($vo) == $edit["DocYear"]): ?>selected="selected"<?php endif; ?>> <?php echo ($vo); ?></option><?php } ?>
                        </select>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="center">
                        <div style="width:85%;margin:5px">
                            ...
                            <div class="impBtn fLeft">
                                <input tag='form1' u="<?php echo U('Doc/WlnDoc/savexls');?>" type="button" value="保存" class="save imgButton mysubmit">
                            </div>
