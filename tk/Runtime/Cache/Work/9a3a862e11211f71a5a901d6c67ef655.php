        ...
        <div class="w-right">
            <div id="rightTop" class="crumbs-wrap">
                <div id="categorylocation" class="g-crumbs">
                    <span class="now-path">当前位置：</span><span id="local_text"></span> > 作业模块 > 批改作业
                </div>
            </div>
            <!--批改作业标题-->
            <div class="public-title">
                ...
                <div class="add-work-info">
                    <div class="info">
                        留作业流程：
                        <a href="<?php echo U('Manual/Index/zj');?>">手工出题</a>
                        （
                        <a href="<?php echo U('Ga/Index/index');?>">智能组卷</a>
                        ）
                        <cite>></cite>
                        <a href="<?php echo U('Home/Index/zuJuan');?>">试卷预览</a>
                        <cite>></cite>
                        <a href="<?php echo U('Home/Index/zuJuan');?>">创建作业</a>
                        <cite>></cite>
                        <a href="<?php echo U('Work/Work/addWork');?>">分配作业</a>
                        <cite>></cite>
                        <a href="<?php echo U('Work/Work/checkWork');?>">批改作业</a>
                    </div>
                </div>
            </div>
