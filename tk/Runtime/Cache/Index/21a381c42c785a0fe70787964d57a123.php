...
$(document).ready(function(){
    ...
    var specialID='<?php echo ($edit["PID"]); ?>';
    if("<?php echo ($act); ?>"=='edit'){
        $('#special').allSelectLoad('/Index/WlnSpecial',{"style":"getMoreData","list":"special","subjectID":subjectID,"idList":{
        "special":specialID}})
    }
...
<div class="content">
<!--  功能操作区域  -->
<div class="title"><?php echo ($pageName); ?> [ <A HREF="/Index/WlnSpecial">返回列表</A> ]</div>
<!-- 功能操作区域结束 -->
...
<TR>
    ...
    <TD class="tLeft" ><INPUT TYPE="text" class="large bLeft"  check='Require' warning="专题不能为空" NAME="SpecialName" value="<?php echo ((isset($edit["SpecialName"]) && ($edit["SpecialName"] !== ""))?($edit["SpecialName"]):''); ?>"></TD>
</TR>
<TR>
...
<TR>
    ...
    <TD class="center"><div style="width:85%;margin:5px">
        <INPUT TYPE="hidden" name="SpecialID" value="<?php echo ($edit["SpecialID"]); ?>">
        <INPUT TYPE="hidden" name="act" value="<?php echo ($act); ?>">
    <div class="impBtn fLeft"><INPUT tag='form1' u="<?php echo U('WlnSpecial/save');?>" TYPE="button" value="保存" class="save imgButton mysubmit"></div>
