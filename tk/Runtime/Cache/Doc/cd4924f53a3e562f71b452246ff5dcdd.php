...
<div class="operate">
    ...
    <!-- 查询区域 -->
    <FORM METHOD="POST" ACTION="<?php echo U('Doc/DocInner/getlog');?>">
    <div class="fRig">
    ...
    <div id="searchM" class=" none search cBoth">
        ...
        <TR>
            ...
            <option value="0" <?php if(($_REQUEST['Status']) == "0"): ?>selected="selected"<?php endif; ?>>成功</option>
            <option value="1" <?php if(($_REQUEST['Status']) == "1"): ?>selected="selected"<?php endif; ?>>失败</option>
            </SELECT></TD>
        </TR>
        </TABLE>
    </div>
...
<table id="checkList" class="list" cellpadding="5" cellspacing="0" border="1">
    ...
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$node): $mod = ($i % 2 );++$i;?><tr class="row lists" jl=''>
        ...
        <td><?php if(($node["Status"]) == "0"): ?>成功<?php endif; ?>
        <?php if(($node["Status"]) == "1"): ?><font color="red">失败</font><?php endif; ?>
        </td>
