...
<div id="main" class="main" >
    <!-- 主体内容  -->
    <div class="content" >
        <div class="title"><?php echo ($pageName); ?> [ <A HREF="javascript:history.go(-1);">返回上一页</A> ] <span class="red">* 文档提取试题以后才会有相应html版</span> </div>
        <!--  功能操作区域  -->
        <div class="operate">
                        ...
                        <tr>
                            ...
                            <td>
                                <select class="small bLeft" name="DocYear">
                                    <option value="">选择</option>
                                    <?php $__FOR_START_24283__=$thisYear;$__FOR_END_24283__=1990;for($vo=$__FOR_START_24283__;$vo > $__FOR_END_24283__;$vo+=-1){ ?><option value="<?php echo ($vo); ?>" {#eq name="vo" value="<?php echo ($_REQUEST['DocYear']); ?>"#}selected="selected"{#/eq#}> <?php echo ($vo); ?></option><?php } ?>
                                </select>
                            </td>
        ...
        <div class="list" >
            ...
            <table id="checkList" class="list" cellpadding="5" cellspacing="0" border="1">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$node): $mod = ($i % 2 );++$i;?><tr class="row lists" jl=''>
                        ...
                        <td>
                            <a href="#" class="btedit" thisid="<?php echo ($node["DocID"]); ?>"><?php echo ($node["DocName"]); echo ($node["ShowWhere"]); ?></a>
                            ...
                            <p>
                                ...
                                <?php if($node["Hearing"] != 0): ?><br><a href='<?php echo U('Doc/WlnDoc/downloadAudioFile', array('docId'=>$node['Hearing']));?>'>下载听力</a><?php endif; ?>
                            </p>
                        </td>
                        <td>
                        ...
                        <td>
                            <a href="#" class="btedit" thisid="<?php echo ($node["DocID"]); ?>">编辑</a><br/>
                            <a href="<?php echo U('Doc/WlnDoc/testsave',array('DocID'=>$node['DocID']));?>">提取试题</a><br/>
                            ...
                            <a href="<?php echo U('Test/Test/introlist',array('DocID'=>$node['DocID'],'ShowWhere'=>'All'));?>">入库试题</a><br/>
