...
<!-- 主体内容  -->
<div class="content" >
<div class="title"><?php echo ($pageName); ?>  <!--<a href="<?php echo U('LogTplPaper/rename');?>">替换数据</a>--></div>
<!--  功能操作区域  -->
<div class="operate">
    ...
    <!-- 查询区域 -->
    <FORM id="form1" METHOD="POST" ACTION="/Dir/LogTplPaper">
    <div class="fRig">
...
<table id="checkList" class="list" cellpadding="5" cellspacing="0" border="1">
    ...
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$node): $mod = ($i % 2 );++$i;?><tr class="row lists" jl=''>
        ...
        <td><a href="<?php echo U('LogTplPaper/showMsg',array('id'=>$node[PaperID]));?>" class="showmsg" thisid="<?php echo ($node["PaperID"]); ?>">查看详情</a>&nbsp;</td>
