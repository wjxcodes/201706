...
<!-- 主体内容  -->
<div class="content" >
<div class="title"><?php echo ($pageName); ?> [ <A HREF="<?php echo U('Test/Test/index');?>">返回列表</A> ]  [ <A
        HREF="javascript:history.go(-1);">返回上一页</A> ]</div>
<!--  功能操作区域  -->
<div class="operate">
    <div class="impBtn hMargin fLeft shadow" ><input type="button" id="" name="add" value="导入" onclick="" class="btdr add imgButton"></div>
...
<table id="checkList" class="list" cellpadding="5" cellspacing="0" border="1">
    ...
    <?php if(is_array($newarr)): $t = 0; $__LIST__ = $newarr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$node): $mod = ($t % 2 );++$t;?><tr class="row lists" jl=''>
        ...
        <?php if(is_array($node)): $i = 0; $__LIST__ = $node;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><td><div style="width:200px;height:100px;overflow:auto;"><p><?php echo ($vo); ?></div></td><?php endforeach; endif; else: echo "" ;endif; ?>
