...
<div id="main" class="main" >
    ...
    <div class="content" >
        <div class="title">
            <?php echo ($pageName); ?> 
            [<a href="<?php echo U('PowerAdminList/upgradeModelCache');?>">更新分组模型</a>]
            [<a href="<?php echo U('PowerAdminList/check');?>">未设置权限列表</a>]
            [<a href="<?php echo U('PowerAdminList/deleteNoUse');?>">删除不存在的权限</a>]
            [<a href="<?php echo U('PowerAdminList/updateCache');?>">更新缓存</a>]
        </div>
        <!--  功能操作区域  -->
        <div class="operate">
            ...
            <!-- 查询区域 -->
            <FORM id="form1" METHOD="POST" ACTION="/Manage/PowerAdminList">
                <div class="fRig">
                    <div class="fLeft"><span id="key"><INPUT id="name" TYPE="text" NAME="PowerName" value="<?php echo ($_REQUEST['PowerName']); ?>" title="管理员权限名查询" class="medium" ></span></div>
        ...
        <div class="list" >
            ...
            <table id="checkList" class="list" cellpadding="5" cellspacing="0" border="1">
                ...
                <?php if(is_array($powerArray)): $i = 0; $__LIST__ = $powerArray;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cnode): $mod = ($i % 2 );++$i; if(is_array($cnode)): $i = 0; $__LIST__ = $cnode;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$node): $mod = ($i % 2 );++$i;?><tr class="row lists" jl=''>
                    ...
                    <td><?php if($node["IfSubject"] == 1): ?><font color="red">是</font><?php else: ?>否<?php endif; ?></td>
